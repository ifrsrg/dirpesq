...
function remove_page_all(id) {
	if(confirm('Do you want to delete the all fields in this page?'))
	{
		...
		if(form_view_count == 2) {
			document.getElementById("form_id_tempform_view_img1").classList.remove('form_view_show');
			document.getElementById("form_id_tempform_view_img1").classList.add('form_view_hide');
		}
