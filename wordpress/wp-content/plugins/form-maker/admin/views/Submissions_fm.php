...
class  FMViewSubmissions_fm extends FMAdminView {
	...
	public function forms( $params ) {
		...
		<div class="tablenav top">
			...
			<div class="fm-export-tools">
				<?php $blocked_ips_link = add_query_arg(array( 'page' => 'blocked_ips_fm' ), $page_url); ?>
  ...
  <div class="wrap">
		...
		?>
		<form action="admin.php?page=submissions_fm" method="post" id="adminForm" name="adminForm"  class="form_maker_submissions_edit wd-form">
