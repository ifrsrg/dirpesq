...
class FMViewThemes_fm extends FMAdminView {
  ...
  public function display( $params ) {
    ...
    $form_attr = array(
      ...
      'action' => add_query_arg(array( 'page' => 'themes_fm' ), 'admin.php'),
    );
   ...
   */
    ...
    wp_enqueue_script('fm-themes');
        ...
        .fm-form-content select.isBG{
          background:{{IPBGColor}} url(<?php echo WDFM()->plugin_url; ?>/{{SBPBackground}}) {{SBPBGRepeat}} {{SBPBGPos1}} {{SBPBGPos2}} !important;
        ...
        .fm-calendar-button span{
          ...
          background: url(<?php echo WDFM()->plugin_url; ?>/{{OPDPIcon}}) {{OPDPRepeat}} {{OPDPPos1}} {{OPDPPos2}} !important;
        }
                            ...
                            <div class="fm-column">
                              ...
                              <div class="fm-row">
                                <div type="type_date" class="wdform-field">
                                  <div class="wdform-label-section" style="float: left; width: 90px;">
                                    <span class="wdform-label"><?php _e('Date:', WDFM()->prefix); ?></span>
                                  </div>
                              ...
                              <div class="fm-row">
                                <div type="type_submit_reset" class="wdform-field subscribe-reset">
                                  ...
                                  <div class="wdform-element-section" style="display: table-cell;">
                                    <button type="button" class="fm-button-subscribe" ng-class="{borderRight : SPBorderRight, borderLeft : SPBorderLeft, borderBottom : SPBorderBottom, borderTop : SPBorderTop, borderHoverRight : SHPBorderRight, borderHoverLeft : SHPBorderLeft, borderHoverBottom : SHPBorderBottom, borderHoverTop : SHPBorderTop}" ><?php _e('Submit', WDFM()->prefix); ?></button>
                                    <button type="button" class="fm-button-reset" ng-class="{borderRight : BPBorderRight, borderLeft : BPBorderLeft, borderBottom : BPBorderBottom, borderTop : BPBorderTop, borderHoverRight : BHPBorderRight, borderHoverLeft : BHPBorderLeft, borderHoverBottom : BHPBorderBottom, borderHoverTop : BHPBorderTop}"><?php _e('Reset', WDFM()->prefix); ?></button>
                                  </div>
                                </div>
                              </div>
                              <div class="fm-clear"></div>
